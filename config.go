...
func initConfig() *types.Config {
	...
	return types.NewConfig(RedditSecretKey, TwitterAccessKey, TwitterAccessSecret, TwitterApiKey, TwitterApiSecret, TwitterBearerToken, NeoEndpoint, NeoUser, NeoPassword)
}
